...
async def planner_node(state: AgentState, runtime: AgentRuntime) -> dict:
    ...
    if plan_step >= max_steps:
        ...
        out = {
            ...
            "data_query": data_q,
            "node_flags": flags,
            "data_process_description": description,
            "plan_done": True,
            "pending_tool": None,
    ...
    raw = await invoke_llm_decision(runtime.llm, prompt, phase="planner")
    ...
    data_process_description = parsed["data_process_description"]
